...
selectGame.addEventListener("change", function () {
    ...
    window.location.href = `/en/${selectedGameValue}`;
});
...
selectServer.addEventListener("change", function () {
    ...
    window.location.href = `/en/${selectedGameValue}/${selectedServerValue}`;
});
...
selectFaction.addEventListener("change", function () {
    ...
    window.location.href = `/en/${selectedGameValue}/${selectedServerValue}/${selectedFactionValue}`;
});
